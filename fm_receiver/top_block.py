...
# Title: Top Block
# Generated: Sat Jan 12 10:09:26 2019
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.channel_freq_slider = channel_freq_slider = 93.4e6
        self.samp_rate = samp_rate = 10e6
        self.channel_width = channel_width = 200e3
        self.channel_freq = channel_freq = channel_freq_slider
        ...
        _channel_freq_slider_sizer = wx.BoxSizer(wx.VERTICAL)
        self._channel_freq_slider_text_box = forms.text_box(
        	parent=self.GetWin(),
        	sizer=_channel_freq_slider_sizer,
        	value=self.channel_freq_slider,
        	callback=self.set_channel_freq_slider,
        	label='channel_freq_slider',
        	converter=forms.float_converter(),
        	proportion=0,
        )
        self._channel_freq_slider_slider = forms.slider(
        	parent=self.GetWin(),
        	sizer=_channel_freq_slider_sizer,
        	value=self.channel_freq_slider,
        	callback=self.set_channel_freq_slider,
        ...
        self.Add(_channel_freq_slider_sizer)
    ...
    def get_channel_freq_slider(self):
        return self.channel_freq_slider

    def set_channel_freq_slider(self, channel_freq_slider):
        self.channel_freq_slider = channel_freq_slider
        self.set_channel_freq(self.channel_freq_slider)
        self._channel_freq_slider_slider.set_value(self.channel_freq_slider)
        self._channel_freq_slider_text_box.set_value(self.channel_freq_slider)
